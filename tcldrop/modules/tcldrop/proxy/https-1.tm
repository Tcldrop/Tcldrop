...
#
# Copyright (C) 2003,2004,2005 by Philip Moore <FireEgl@Tcldrop.Org>
# This code may be distributed under the same terms as Tcl.
#
# RCS: @(#) $Id: https.tcl,v 1.4 2005/05/03 05:17:39 fireegl Exp $

namespace eval ::proxy::https {
	package require Tcl 8.3
	variable version {0.2}
	package provide proxy::https $version
	variable rcsid {$Id: https.tcl,v 1.4 2005/05/03 05:17:39 fireegl Exp $}
	variable Count
